# ⛓️ go-bc
> The go-to Bitcoin Block Chain (BC) GoLang library (Forked from [libsv/go-bc](https://github.com/libsv/go-bc))
  ...
  <tbody>
    <tr>
      <td valign="top" align="left">
        <a href="https://github.com/bsv-blockchain/go-bc/releases">
          <img src="https://img.shields.io/github/release-pre/bsv-blockchain/go-bc?logo=github&style=flat" alt="Latest Release">
        </a><br/>
        <a href="https://github.com/bsv-blockchain/go-bc/actions">
          <img src="https://img.shields.io/github/actions/workflow/status/bsv-blockchain/go-bc/fortress.yml?branch=master&logo=github&style=flat" alt="Build Status">
        </a><br/>
		    <a href="https://github.com/bsv-blockchain/go-bc/actions">
          <img src="https://github.com/bsv-blockchain/go-bc/actions/workflows/codeql-analysis.yml/badge.svg?style=flat" alt="CodeQL">
        </a><br/>
		    <a href="https://sonarcloud.io/project/overview?id=bsv-blockchain_go-bc">
          <img src="https://sonarcloud.io/api/project_badges/measure?project=bsv-blockchain_go-bc&metric=alert_status&style-flat" alt="SonarCloud">
        </a>
      </td>
      <td valign="top" align="left">
        <a href="https://goreportcard.com/report/github.com/bsv-blockchain/go-bc">
          <img src="https://goreportcard.com/badge/github.com/bsv-blockchain/go-bc" alt="Go Report Card">
        </a><br/>
		    <a href="https://codecov.io/gh/bsv-blockchain/go-bc/tree/master">
          <img src="https://codecov.io/gh/bsv-blockchain/go-bc/branch/master/graph/badge.svg?style=flat" alt="Code Coverage">
        </a><br/>
		    <a href="https://scorecard.dev/viewer/?uri=github.com/bsv-blockchain/go-bc">
          <img src="https://api.scorecard.dev/projects/github.com/bsv-blockchain/go-bc/badge?logo=springsecurity&logoColor=white" alt="OpenSSF Scorecard">
        </a><br/>
      ...
      <td valign="top" align="left">
        <a href="https://golang.org/">
          <img src="https://img.shields.io/github/go-mod/go-version/bsv-blockchain/go-bc?style=flat" alt="Go version">
        </a><br/>
        <a href="https://pkg.go.dev/github.com/bsv-blockchain/go-bc?tab=doc">
          <img src="https://pkg.go.dev/badge/github.com/bsv-blockchain/go-bc.svg?style=flat" alt="Go docs">
        </a><br/>
      ...
      <td valign="top" align="left">
        <a href="https://github.com/bsv-blockchain/go-bc/graphs/contributors">
          <img src="https://img.shields.io/github/contributors/bsv-blockchain/go-bc?style=flat&logo=contentful&logoColor=white" alt="Contributors">
        </a><br/>
		    <a href="https://github.com/bsv-blockchain/go-bc/commits/master">
		      <img src="https://img.shields.io/github/last-commit/bsv-blockchain/go-bc?style=flat&logo=clockify&logoColor=white" alt="Last commit">
		    </a><br/>
...
All unit tests and [examples](examples) run via [GitHub Actions](https://github.com/bsv-blockchain/go-bc/actions) and use [Go version 1.24.x](https://go.dev/doc/go1.24). View the [configuration file](.github/workflows/fortress.yml).
