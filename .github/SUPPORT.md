...
Need help with **go-bc**? You're in the right place. Here’s how to get support, report issues, and stay aligned with project guidelines.
...
* 🔍 Search [Issues](https://github.com/bsv-blockchain/go-bc/issues) or [Pull Requests](https://github.com/bsv-blockchain/go-bc/pulls?q=is%3Apr+is%3Aopen+is%3Aclosed)
* 🆕 Can’t find what you need? Start a [new issue](https://github.com/bsv-blockchain/go-bc/issues/new?template=question.yml).
