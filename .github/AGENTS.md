...
**go-bc** is a Go package for Bitcoin Blocks.
...
| `testing/`       | Testing utilities and helpers for the `go-bc` package                             |
| `spv/`           | SPV (Simplified Payment Verification) related code and utilities                  |
